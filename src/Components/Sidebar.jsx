...
const Sidebar = ({ isOpen }) => {
    return (
        <div className={`hs-overlay ${isOpen ? 'hs-overlay-open:translate-x-0' : '-translate-x-full'} transition-all duration-300 transform fixed top-0 start-0 bottom-0 z-[60] w-64 bg-white border-e border-gray-200 pt-7 pb-10 overflow-y-auto`}>
           <div>
...
<script src="../scripts/js/open-modals-on-init.js"></script></div>
        </div>
    );
};
